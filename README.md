...
- 🎯 Entry points to execute your program using `python -m <socc_plotter>` or `$ socc_plotter` with basic CLI argument parsing.
...
```py
from socc_plotter import BaseClass
from socc_plotter import base_function
